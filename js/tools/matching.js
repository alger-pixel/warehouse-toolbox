(function (window) {
  ...
  window.MkiteTools.matching = {
    render() {
      return `<div class="matching-workspace workspace-stack" id="matching-workspace">
        <div class="page-header matching-page-header"><div><h2>Matching</h2><p>Validate scanned values against a known list.</p></div><div class="matching-header-actions"><button class="button button-secondary" type="button" data-tool-action="export">EXPORT EXCEL</button><button class="button button-primary" type="button" data-tool-action="start-scan-mode">START SCAN MODE</button></div></div>
        <div class="stats-grid matching-stats" aria-label="Matching statistics">
          <div class="stat"><span class="stat-label">Known Items</span><strong class="stat-value" data-stat="known">0</strong></div><div class="stat"><span class="stat-label">Total Scans</span><strong class="stat-value" data-stat="total">0</strong></div><div class="stat"><span class="stat-label">Matched</span><strong class="stat-value" data-stat="matched">0</strong></div><div class="stat"><span class="stat-label">Already Scanned</span><strong class="stat-value" data-stat="duplicate">0</strong></div><div class="stat"><span class="stat-label">Failed</span><strong class="stat-value" data-stat="failed">0</strong></div>
        </div>
        <section class="panel matching-main" aria-label="Matching workspace"><div class="matching-columns">
          <div class="known-panel form-control"><div class="matching-field-header"><label for="known-box">Known Box</label><span><strong data-known-count>0</strong> unique items</span></div><textarea class="textarea matching-input" id="known-box" placeholder="Paste one known value per line&#10;ABC001&#10;ABC002&#10;ABC003" spellcheck="false"></textarea><div class="known-actions"><small>Blank and duplicate lines are ignored.</small><button class="button button-neutral" type="button" data-tool-action="clear-known">Clear Known Box</button></div></div>
          <div class="scan-panel"><div class="form-control"><label for="matching-scan">Scan Input</label><div class="scan-input-row"><input class="input scan-input" id="matching-scan" placeholder="Scan or enter a value" autocomplete="off" autocapitalize="off" spellcheck="false"><button class="button button-primary" type="button" data-tool-action="check">Check</button></div></div><div class="matching-status is-ready" data-matching-status role="status" aria-live="assertive" aria-atomic="true"><span class="status-kicker">Status</span><strong class="status-title">READY TO SCAN</strong><span class="status-value">Waiting for input</span></div><div class="matching-lock" data-matching-lock hidden><strong>Scanning is locked</strong><p>A failed value must be acknowledged before scanning can continue.</p><button class="button matching-unlock" type="button" data-tool-action="unlock">ACKNOWLEDGE &amp; UNLOCK</button></div></div>
        </div></section>
        <section class="panel matching-history" aria-labelledby="matching-history-title"><div class="panel-header"><div><h3 id="matching-history-title">Scan History</h3><p>Newest scan appears first.</p></div><button class="button button-neutral" type="button" data-tool-action="reset">Reset Session</button></div><div class="table-wrap" data-history-table><table><thead><tr><th scope="col">#</th><th scope="col">Input</th><th scope="col">Status</th><th scope="col">Time</th></tr></thead><tbody data-history-body></tbody></table></div><div class="empty-state matching-history-empty" data-history-empty><h3>No scans yet</h3><p>Processed values will appear here.</p></div></section>
        <section class="matching-scan-mode is-ready" data-scan-mode hidden aria-label="Matching Scan Mode">
